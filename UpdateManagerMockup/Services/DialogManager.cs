...
namespace UpdateManagerMockup.Services
{
    ...
    public static class DialogHelper
    {
        ...
        public static async Task<IEnumerable<string>?> OpenFileDialogAsync(this object? context, string? title = null, bool selectMany = false)
        {
            if (context == null)
            {
